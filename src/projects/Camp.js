      ...
      <>
        ...
        <div className="row">
          ...
          <div className="col-sm-5">
            ...
            <p>
              This is a React app where you can search campsites in the US and
              plan an outdoor camping trip with your friends. This was a group
              project, and I designed/implemented user-related functionalities.
            </p>
            <h4 className="text-4 font-weight-600">Lesson learned:</h4>
            <p>
              Since my teammate built the foundation of this app, I had to learn
              to build on top of an existing codebase, unlike my other projects.
              Also, I gained a more in-depth understanding of git because my
              teammates and I were working on the same app simultaneously.
            </p>
