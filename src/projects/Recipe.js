        ...
        <div className="row">
          <div className="col-sm-7 mb-4 mb-md-0">
            ...
            >
              <div className="item imglink">
                {" "}
                <a href="https://www.recipe-thief.com">
          ...
          <div className="col-sm-5">
            ...
            <p>
              ...
              save and view the recipes. More functionality to come! Note that the website only supports desktop and tablet view in this version (mobile view coming soon).
            </p>
            ...
            <ul className="list-style-2">
              ...
              <li className="">
                ...
                <a
                  href="https://www.recipe-thief.com"
                  target="_blank"
                >
                  Recipe Thief
                </a>
